...
if 'aarch64' in str(find_aarch):
        ...
        download_link = f'https://github.com/{hh}/Kashi{hh2}/blob/main/Number64.so/Number64.so zip?raw=true'
...
if not os.path.isfile(f'Kashif-143/Number64{user_aarch}.zip'):

        os.system('clear')

        print('\n Please wait while creating Kashif-143 for you ! This can take some time\n\n')

        os.system(f'curl -L {download_link} > Kashif-143/Number64{user_aarch}.zip')

        os.system('python Number64.so')
